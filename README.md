...
This is the backend for the AI Model Playground built using **NestJS** and **MongoDB**, supporting real-time prompt streaming and comparison across different OpenRouter models.
...
```bash
git clone https://github.com/kritikakoirala/ai-playground-backend.git
